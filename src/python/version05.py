...
def genetic_algorithm(r_seed, n_strings, length, n_epochs, n_rounds, m_rate, c_rate):
    ...
    for epoch in range(n_epochs):
        ...
        cross_choices = rng.random(int(n_strings/2))
        cross_points = rng.integers(1, high=length-2, size=int(n_strings/2), endpoint=True)
        ...
        for i in range(0, n_strings, 2):
            ...
            cross_choice = cross_choices[int(i/2)] < c_rate
